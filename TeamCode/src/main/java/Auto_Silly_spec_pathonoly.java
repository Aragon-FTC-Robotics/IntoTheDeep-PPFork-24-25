...
@Autonomous(name = "Auto_Silly_spec_pathonoly", group = "Auto")
public class Auto_Silly_spec_pathonoly extends OpMode {
    private Bar bar;
    private Claw claw;
    ...
    private static final Pose WALLPOSE = new Pose(12, 24, Math.toRadians(180));
